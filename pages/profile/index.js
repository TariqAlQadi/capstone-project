      ...
      {session && (
        <>
          ...
          <StyledProfileSection>
            ...
            <p>
              I have added{" "}
              <StyledNumber number={numberLiked}>{numberLiked}</StyledNumber>{" "}
              tricks to my repertoire!
            </p>
            <p>
              I am learing{" "}
              <StyledNumber number={numberLearning}>
                {numberLearning}
              </StyledNumber>{" "}
              tricks right now!
            </p>
            <p>
              And I have mastered{" "}
              <StyledNumber number={numberMastered}>
                {numberMastered}
              </StyledNumber>{" "}
              tricks!
            </p>
          ...
          <StyledProfileSectionBottom>
            ...
            >
              <SVGIcon
                variant={
                  filter === "isLearning" ? "learning" : "learningOutline"
                }
                width="40px"
